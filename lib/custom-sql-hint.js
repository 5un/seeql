...
export const registerCustomSQLHint = (CodeMirror) => {
  "use strict";
  ...
  CodeMirror.registerHelper("hint", "sql", function(editor, callback, options) {
    ...
    // look at type and grave accent

    // return {
    //   list: [
    //     {text: 'value 1', count: 500, totalCount: 1000, render: renderHintColumnValueBar },
    //     {text: 'value 2', count: 300, totalCount: 1000, render: renderHintColumnValueBar },
    //     {text: 'value 3', count: 200, totalCount: 1000, render: renderHintColumnValueBar },
    //   ],
